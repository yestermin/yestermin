...
회식 자리에서는 존재감이 없다. 목소리가 제일 작고, 농담도 제일 늦게 웃는다. 남들 다 웃고 3초 지나서야 "아... 그거 웃긴 거였구나" 하는 표정으로 따라 웃는 타입이다. 그런데 다음 날 회의실에 들어가면 얘기가 달라진다. 아무도 안 시켰는데 코드 리뷰를 해와 있고, "이 부분은 이렇게 하면 위험할 수 있어요"를 조곤조곤 짚는다.
...
제일 먼저 체감되는 건 지구력이다. 방대한 코드베이스나 긴 문서를 통째로 넘겨도 앞뒤 맥락을 놓치지 않고 따라간다. 500페이지짜리 보고서를 한 번에 정독하고 목차까지 외워 온 후배 같은 느낌이랄까. 심지어 3장에서 흘리듯 언급한 변수명을 480페이지에서 다시 꺼내며 "어, 이거 아까 그거 아닌가요?" 한다. 중간에 "어, 그게 뭐였죠?"로 되돌아오는 일이 적다.
...
성격도 한몫한다. 확신에 찬 오답을 시원하게 던지기보다, 불확실하면 불확실하다고 말하는 쪽이다. "이건 제가 100% 확신은 못 하는데요"를 회의 중에 세 번쯤 말하는 사람, 회식 자리에선 답답해도 프로덕션 배포 전날에는 세상에서 제일 고마운 사람이다. 재미로 치면 확실히 손해다. 대신 틀리면 곤란해지는 일에서는 이 조심스러움이 곧 신뢰가 된다.
...
아쉬운 쪽은 취향 문제에 가깝다. 화끈하고 자극적인 밈이나 농담을 기대하면 성격상 좀 얌전하다. 유행어 던지면 "그게 무슨 뜻인지 설명해 드릴까요"부터 나올 사람이다. 실시간 트렌드나 방금 터진 뉴스를 캐묻기에도 어울리는 타입은 아니다. 이쪽은 속도보다 꼼꼼함으로 먹고사는 사람이다.

## 그래서

떠벌리지 않는데 맡기면 해낸다. 야근할 때 옆자리에 있었으면 하는 사람이 있다면 대체로 이런 사람이다. 회식에서는 한 번도 건배사를 안 시켰는데, 퇴사한다고 하면 팀 전체가 제일 먼저 붙잡을 사람이기도 하다.
