# 05. "외주가 반으로 줄었습니다" — 전직을 고민하는 디자이너
...
1. (대표 이미지) A freelance graphic designer in her early thirties sitting at a home studio desk, looking at her phone with a mix of worry and quiet resolve, design mockups and color swatches scattered around her, warm afternoon light through a window, flat vector illustration style, warm muted color palette, no text in the image, 16:9 composition.
2. A simple in-house-made design graphic on one side and a polished professional design on the other, a rising baseline line underneath both, symbolizing the shifting quality threshold in the market, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
3. A portfolio page transforming from plain image thumbnails into a page with short handwritten case-study notes attached beside each one, a magnifying glass over the written explanation, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
4. Two people at a small table negotiating, a scale balancing a price tag on one side and a stack of extra deliverable icons on the other, calm professional mood, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
5. A designer making a phone call with a warm, composed expression, a small notepad on the desk listing five names being checked off one by one, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
