...
*시리즈: 전세계 AI 특장점 열전 | 6/20 | 오늘의 주인공: Canva*

---

오후 네 시 반. 내일 아침에 올릴 카드뉴스가 아직 흰 화면이다. 디자이너는 다른 프로젝트에 붙어 있고, 포토샵은 깔려 있지만 마지막으로 연 게 재작년이다.
...
문구만 던지면 SNS 게시물, 프레젠테이션, 포스터 시안을 여러 개 뽑아준다. 빈 화면 공포증을 없애는 데 이만한 무기가 없다. 마음에 안 들면 다음 시안을 보면 되고, 어차피 첫 시안부터 완벽할 거라 기대하고 여는 도구도 아니다.
...
디자인 실력이 없어도 있는 척할 수 있게 해주는 존재. 마감 직전에 이 고마움을 알게 된다.
