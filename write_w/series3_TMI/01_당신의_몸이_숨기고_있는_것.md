# 01. 당신의 위장은 지금 이 순간에도 자기 자신을 녹이고 있다
...
1. A minimalist human silhouette shown in profile like an x-ray outline, with a glowing stomach organ at its center depicted as a small wall being patched by a tiny paint roller, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 16:9 composition.
2. A cutaway illustration of a stomach interior rendered as a brick wall under gentle acid drips, with a tiny figure repainting the bricks as fast as they wear away, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
3. A close-up of a human eye where the cornea is a perfectly clear glass-like dome with no blood vessels at all, contrasted with faint red vein lines on the surrounding skin, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
4. A side-by-side comparison of a baby skeleton made of many small separate puzzle-piece bones and an adult skeleton with fewer, fused solid bones, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
5. A simple illustration of a figure lying down at night with a faintly glowing, slightly expanded spine, and the same figure standing the next morning slightly taller beside a small height-measuring tape, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
