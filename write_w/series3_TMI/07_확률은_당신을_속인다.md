...
1. A classroom of 23 small figures with thin connecting lines drawn between every pair of them, two of the figures glowing to show a matching birthday, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 16:9 composition.
2. A tangled web of thin lines connecting many small figures in a room, each line representing one comparison between two people, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
3. A single highlighted figure in a classroom with thin lines reaching out only from them to everyone else, much sparser than a web connecting everyone, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
4. A coin mid-flip showing seven identical heads-up outcomes floating above it in a row, with a puzzled small figure watching and expecting tails next, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
5. Three closed doors on a stage, one door glowing faintly behind it, a host figure opening one empty door to reveal nothing, while a contestant figure looks between the two remaining doors, flat vector illustration style, a surprising fun-fact visualized playfully, minimal color palette, no text in the image, 4:3 composition.
