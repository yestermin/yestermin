...
아래 목록이 낯익다면 이미 한 번은 당해봤다는 뜻이다. 결과물이 내 생각과 일치할 때가 첫 번째다. 사람은 자기 생각과 맞는 정보를 덜 의심한다. 역시 내 말이 맞았네 싶은 순간이 검증이 가장 느슨해지는 때다.
...
1. 대표 이미지 — A person at a laptop holding up a magnifying glass to a document full of text, a few specific numbers and citations glowing red under the lens while the rest of the text stays calm and neutral. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 16:9 composition
2. 첫 번째 이미지 자리 (위험 지대를 외운다) — A laptop screen showing a simple danger map with a few zones marked in red — a percentage sign, a calendar, a scales-of-justice icon — and other zones marked calmly in green for low-risk text editing. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
3. 두 번째 이미지 자리 (결과물에 빨간 줄을 그어본다) — A printed document on a laptop screen with several phrases underlined in red pen, a small counter badge showing the tally of flagged items climbing. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
4. 세 번째 이미지 자리 (검증 질문을 던진다) — A chat conversation on a laptop screen splitting into two opposing speech bubbles arguing opposite conclusions, with a third faint bubble in a fresh blank chat window asking the same question again. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
5. 네 번째 이미지 자리 (나만의 검증 규칙을 정한다) — A laptop screen showing a short personal rulebook card with a few strict checklist lines, a small padlock icon on the top rule to show it is non-negotiable. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
