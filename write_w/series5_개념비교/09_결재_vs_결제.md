# 09. 결재 vs 결제 — 팀장님께 '결제' 올렸다가 민망해지기 전에
...
1. A split-composition illustration: on the left, a manager's hand stamping approval on a document held on a clipboard; on the right, a hand swiping a card at a payment terminal with a coin passing between two people, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 16:9 composition.
2. A speech bubble splitting into two paths, one path leading to a clipboard with an approval stamp, the other path leading to a card terminal with a coin icon, testing which path a word belongs to, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
3. A single document flowing through two sequential stages: first passing under an approval stamp, then afterward a coin visibly moving out of a wallet toward a recipient, showing the two steps happening one after another, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
4. Two nearly identical speech bubbles floating side by side, distinguishable only by a tiny visual detail inside each one, one containing a stamp icon and the other a coin icon, representing words that sound alike but look different only up close, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
5. An old dusty paper form on a desk with a stamp icon and a coin icon printed side by side on it, being copied by a new employee at a fresh desk without questioning it, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
