# 06. 프로바이오틱스 vs 프리바이오틱스 — 한 글자 차이로 완전히 다른 걸 사고 있다
...
1. A split-composition illustration: on the left, tiny friendly microbe characters moving into a small house (representing live bacteria as residents); on the right, a refrigerator stocked full of fiber-rich foods like onion, garlic, and whole grains (representing food for those residents), flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 16:9 composition.
2. Small round microbe characters wearing tiny backpacks traveling through a winding tube past acid and bile obstacles, arriving safely at a colon-shaped destination, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
3. A refrigerator with two shelves, one shelf full of fermented foods like yogurt and kimchi jars, the other shelf full of fiber-rich vegetables like onion, garlic, and banana, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
4. A single jar of traditional fermented kimchi with both tiny microbe characters and strands of fiber visible inside it at once, showing both elements coexisting naturally in one food, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
5. A small house full of microbe characters looking hungrily at an empty pantry on one side, next to a well-stocked pantry of vegetables and grains ready to feed them on the other side, flat vector illustration style, split-composition showing two contrasting concepts side by side, minimal color palette, no text in the image, 4:3 composition.
