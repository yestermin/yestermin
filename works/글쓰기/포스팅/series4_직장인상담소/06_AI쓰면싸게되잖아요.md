...
1. (대표 이미지) A freelance writer in her mid-thirties sitting at a small desk with a laptop and a phone held to her ear mid-conversation, a slightly tense but composed expression, cozy home office with warm afternoon light, flat vector illustration style, warm muted color palette, no text in the image, 16:9 composition.
2. A speech bubble showing a price tag icon transforming into a stack of extra deliverable icons — two draft pages and a small report — symbolizing shifting the negotiation from price to scope, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
3. An invoice sheet splitting from one lump-sum box into several itemized boxes labeled with small icons for research, outline, draft, revisions, and follow-up check, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
4. A writer and a client-side coordinator sitting on the same side of a table, both looking together at a budget chart instead of facing off across it, symbolizing partnership rather than confrontation, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
5. A writer standing confidently by a window at her desk, holding a notebook with a couple of short lines written on it, calm resolved expression, soft morning light, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
