# 03. "팀원이 AI로 만든 걸, 제가 검수할 수가 없습니다"
...
1. (대표 이미지) A middle-aged team leader in his early forties sitting at a desk surrounded by a stack of neatly polished documents, rubbing his temple, a faint red flag icon suggesting an unverified number, Korean office setting, flat vector illustration style, warm muted color palette, no text in the image, 16:9 composition.
2. A group of team members each submitting flawless-looking reports that all look identical, the manager unable to tell them apart, symbolic uniform document icons, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
3. A close-up of a document with a number circled and a small tag reading "source" attached to it, representing traceability, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
4. A manager sitting across from a young employee in a short face-to-face conversation, both leaning in, a small thought bubble showing an uncertain point being discussed, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
5. A team leader writing three short rules on a whiteboard in a small meeting room with a few colleagues listening, calm collaborative mood, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
