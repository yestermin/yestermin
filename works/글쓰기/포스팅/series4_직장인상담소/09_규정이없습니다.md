...
*개인정보·노무 관련 사안은 사내 법무 또는 외부 전문가의 검토를 받으시기 바랍니다.*
...
1. (대표 이미지) A thirty-one-year-old HR officer sitting at her desk surrounded by stacks of paper resumes, hesitating over her laptop with a blinking cursor, a faint question mark hovering above her head, Korean office setting, flat vector illustration style, warm muted color palette, no text in the image, 16:9 composition.
2. A resume document with a masking tool covering the name, birthdate, and photo section, leaving only the career experience text visible below, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
3. An HR officer talking with an IT or security colleague across a desk, a short checklist of approved tools appearing on a small screen between them, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
4. A hand typing a short formal email on a laptop, a small envelope icon with a checkmark beside it, symbolizing a written record kept as protection, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
5. An HR officer calmly drafting a one-page policy document with four short bullet points, soft desk lamp light, a quiet sense of ownership and authority, flat vector illustration style, warm muted color palette, no text in the image, 4:3 composition.
