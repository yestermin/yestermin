...
1. 대표 이미지 — A person at a laptop surrounded by a cloud of twenty tiny scattered browser-tab icons, calmly closing most of them while a single short checklist glows on the laptop screen. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 16:9 composition
2. 첫 번째 이미지 자리 (검색 대신 질문 목록부터 만든다) — A laptop screen showing a numbered list of ten question marks forming a neat checklist, replacing a search bar icon that sits crossed out beside it. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
3. 두 번째 이미지 자리 (아는 것과 확인이 필요한 것을 가른다) — A laptop screen with a list of items sorted into three labeled trays — a green checkmark tray, a yellow question-mark tray, a gray empty-box tray — sorted by a simple funnel icon. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
4. 세 번째 이미지 자리 (검색은 여기서 시작한다) — A hand selecting just three or four browser tabs out of a faded crowd of twenty, each remaining tab labeled with a small ranked badge — government building icon, document icon, speech-bubble icon for lower-tier sources. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
5. 네 번째 이미지 자리 (구조로 정리하고 빈칸을 남긴다) — A tidy report document on a laptop screen with three sections — confirmed facts with a checkmark, reasoned estimates with a small gauge icon, and an unknowns section deliberately left with visible blank lines. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
