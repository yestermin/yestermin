...
1. 대표 이미지 — A person at a laptop looking at a long handwritten list of small daily tasks, a magnifying glass hovering over a few of the repetitive-looking items while a gear icon glows faintly behind them. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 16:9 composition
2. 첫 번째 이미지 자리 (지난주에 한 일을 다 적는다) — A laptop screen with a long freeform list of small everyday task icons — a folder being renamed, two spreadsheets being compared side by side, an envelope repeated many times. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
3. 두 번째 이미지 자리 (세 가지 기준으로 거른다) — A funnel on a laptop screen sorting task icons into three labeled bins marked with a lightning bolt for ready-to-automate, a half-filled gear for partial, and a human hand icon for not suited to automation. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
4. 세 번째 이미지 자리 (하나만 고른다) — A hand picking exactly one glowing task icon out of a small cluster of candidates on a laptop screen, the rest fading into the background, a small clock showing accumulated monthly hours beside the chosen one. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
5. 네 번째 이미지 자리 (절차를 글로 적는다) — A laptop screen showing a numbered step-by-step flowchart of a task, with one step highlighted by a question mark revealing a hidden unwritten rule tucked behind it. flat vector illustration style, someone working at a laptop with AI tools, minimal color palette, no text in the image, 4:3 composition
