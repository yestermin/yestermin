...
그리고 몇 분 뒤에 노래가 나온다. 멜로디가 있고, 보컬이 실려 있고, 반주까지 붙어 있는 상태로. 악보를 볼 줄 아느냐는 아무도 묻지 않는다. 콩나물 대가리 하나 그릴 줄 몰라도 이미 후렴구가 귀에 감기는 곡 한 편이 완성돼 있다.
...
장르 폭도 넓다. 발라드, 힙합, 록, 트로트까지 소화하는 편이라 "이런 스타일은 잘 못해요"로 막히는 경우가 드물다. 트로트 시켰다고 갑자기 삐지고 발라드만 부르는 일은 없다는 뜻이다.
...
악보도 못 보는 사람을 순식간에 작곡가로 만들어준다. 데뷔까지 해주지는 않는다. 그 사이 거리는 생각보다 멀어서, 샤워하다 흥얼거린 멜로디와 음원차트 사이에는 여전히 누군가의 밤샘 작업이 필요하다.
