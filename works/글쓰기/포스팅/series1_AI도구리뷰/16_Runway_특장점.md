...
카메라가 없다. 배우도 없고, 조명팀도 없고, 장소 섭외도 안 했다. 제작비 항목에 적을 게 하나도 없는데, "이런 장면이 필요해요"라고 설명하면 그럴듯한 영상 클립이 나온다.
...
문장 하나, 이미지 한 장으로 클립이 만들어진다는 게 제일 눈에 띄는 부분이지만, 실무에서 더 자주 쓰이는 건 편집 쪽일 수도 있다. 그린스크린 없이 배경을 제거하고, 특정 오브젝트만 지우고, 슬로모션을 만들어낸다. 화면 구석에 몰래 찍힌 행인이나 케이블선을 지우느라 밤새던 편집자 입장에서는 이게 감독 데뷔보다 더 반가운 기능일 수 있다. 영상 편집자가 시간을 제일 많이 쏟는 구간들이다.
...
제작비 0원으로 일단 그려보는 스케치북. 촬영을 없애주진 않지만, 촬영 전에 헤매는 시간을 줄여준다. "이 장면 이렇게 가면 될까요?"를 회의 백 마디 대신 영상 10초로 보여주는 신인 감독인 셈이다.
