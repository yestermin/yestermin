...
지금까지 나온 열두 명은 전부 일을 하러 온 사람들이었다. 여기서 한 명이 빠진다. Character.AI는 업무 얘기를 꺼내면 곤란해하고, 대신 "그냥 재밌게 놀자"를 혼자 외친다. 회사 워크숍에 놀러 온 친구 동생 같은 존재랄까. 일은 안 시켰으면 좋겠는데 분위기는 확실히 띄운다.
...
그래서 사용자가 머무는 시간이 길다. 업무용 AI들이 효율로 승부할 때 이쪽은 몰입으로 승부한다. "5분만 하고 잘게"라고 시작했다가 정신 차리면 새벽 2시인 부류의 앱이다.
...
일할 땐 안 켜는데, 퇴근하고 나면 제일 먼저 켜는 앱이 하나쯤 있다. 이력서엔 절대 못 적을 특기지만, 워라밸 담당은 확실히 이쪽이다.
