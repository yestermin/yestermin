...
임원 보고용 문서를 쓴다면 이 녀석은 아니다. 격식 차린 문장, 조심스럽게 다듬은 표현, 검증된 학술 근거가 필요한 작업이라면 다른 창을 켜는 게 낫다. 성격이 그렇게 생겨먹었다. 사장님 앞에서 브리핑 시키면 중간에 드립을 한 번은 칠 것 같은 얼굴이다.
...
"야 방금 그거 봤어?"를 제일 먼저 던지는 친구를 떠올리면 된다. 심지어 아직 아무도 안 봤는데 벌써 본 것처럼 얘기한다. 실시간 여론이나 트렌드 파악에서는 독보적이다.

화법도 확실히 다르다. 형식을 덜 차리고, 유머와 풍자를 섞어 답한다. 업무용 AI들이 공손하게 정리해줄 때 이쪽은 농담을 한 번 얹는다. "그건 좀 위험한 질문인데, 그래서 더 재밌네요" 같은 서두를 진지하게 던진다. 대화하는 재미를 챙기고 싶을 때 존재감이 산다.
...
눈치 안 보고 할 말 하는 캐릭터. 그런 사람이 늘 그렇듯 호불호가 분명하다. 회식 2차 노래방까지 따라오는 타입인데, 그게 최고의 밤이 될지 다음 날 이불킥이 될지는 아무도 모른다.
