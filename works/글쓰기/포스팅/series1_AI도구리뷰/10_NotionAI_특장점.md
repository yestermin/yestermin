...
조건부터 말하는 게 정직할 것 같다. Notion을 안 쓰는 팀이라면 이 편은 그냥 구경이다. Notion AI의 매력은 전부 Notion 안에서 나오고, 밖으로 나오면 그냥 평범한 AI가 된다. 회사 정문 패스 없이는 아무리 유능해도 로비에서 발이 묶이는 직원 같은 거다.

Notion을 쓰는 팀이라면 얘기가 완전히 달라진다.

## 회사 문서를 제일 잘 아는 사람

Notion AI는 메모·문서·프로젝트 관리 툴 안에 살면서, 그동안 쌓인 회의록과 기획서와 위키 문서를 다 읽고 있다. 나서서 떠들지 않다가 "저번 회의록 요약 좀"이라고 하면 바로 내놓는 총무 직원 캐릭터다. 3년 전에 아무도 안 보는 폴더 구석에 묻어둔 문서까지 기억하고 있다가 필요할 때 슥 꺼내는데, 그 폴더 만든 사람도 잊고 있었다. 새로운 걸 만들어내기보다 이미 있는 걸 정리하고 다듬는 쪽에 특화돼 있다.
...
화려하게 나서지 않는데, 없어지면 그때 알게 되는 종류의 존재다. 회사 탕비실 냉장고 같은 거다. 있을 땐 티도 안 나다가, 없어지는 순간 팀 전체가 패닉에 빠진다.

Notion을 이미 쓰는 팀이라는 전제로 매기면 ⭐️⭐️⭐️⭐ (4.0/5) — 문서 기반 업무 자동화 최적화, Notion 생태계 밖에선 매력 반감.

## 시리즈를 마치며

열 명을 만나고 나니 남는 건 순위표가 아니라 인상착의다. 만능이지만 전문가는 아닌 친구, 회식보다 회의실에서 빛나는 동료, 회식에서만 빛나는 친구, 청바지 입고 나타난 신입, 글자만 못 쓰는 화가. 한자리에 모아놓으면 회사 워크숍 단체사진처럼 어색하고 재밌을 것 같은 조합이다.
